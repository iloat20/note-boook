...
const { DIVIDEND_KEY, getNextId, saveData, getData, markDataDirty, upsertAndSave, deleteAndSave } = require('../storageCore/core')
...
const Dividend = {
  ...
  create(stockId, perShareAmount, quantity, date, note, type, shareQuantity) {
    return createDividend(stockId, perShareAmount, quantity, date, note, type, shareQuantity, getNextId())
  },
