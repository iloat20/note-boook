...
const { TRANSACTION_KEY, getNextId, saveData, getData, markDataDirty, upsertAndSave, deleteAndSave } = require('../storageCore/core')
...
const Transaction = {
  ...
  create(stockId, type, price, quantity, fee, date, note, reason, strategies) {
    return createTransaction(stockId, type, price, quantity, fee, date, note, reason, strategies, getNextId())
  },
